...
im = Image.open(r'/Users/peterlee/editor_source/editor_compound_texts/thumbnail/F91900FB-DABF-44A3-BEEB-5D73A3C84DD9.webp')
convert_image(im, r'/Users/peterlee/editor_source/editor_compound_texts/thumbnail/gif/1.gif')
...
im = im.convert('RGB').convert('P', palette=Palette.ADAPTIVE, colors=255)
...
im.save(r'/Users/peterlee/Desktop/1.gif', transparency=255)